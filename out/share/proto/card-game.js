...
export function cmdFromJSON(object) {
    switch (object) {
        case 0:
        case "NONE":
            return Cmd.NONE;
...
export function cmdToJSON(object) {
    switch (object) {
        case Cmd.NONE:
            return "NONE";
        case Cmd.READY_C2S:
...
export var CompeteForLandLordRoleC2S = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = Writer.create(); }
        if (message.score !== 0) {
...
export var CompeteForLandLordRoleS2C = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = Writer.create(); }
