...
exports.RuleChecker = (function () {
    ...
    RuleChecker.getOrderFromSelected = function (serialArr) {
        ...
        for (var i_3 = 0, len_1 = orderValueArr.length; i_3 < len_1; i_3++) {
            if (orderValueArr[i_3] >= 16 || orderValueArr[i_3] == 15) {
                orderValueArr.splice(i_3, 1);
                i_3--;
            }
        }
    ...
    RuleChecker.shiftNeedlessCardsForPureThreeFly = function (valueList, cardNum) {
        ...
        for (var i_4 = 0; i_4 < valueListRes.length; i_4++) {
            if (i_4 == 0) {
                if (RuleChecker.getCardValue(valueListRes[i_4][0]) + 1 != RuleChecker.getCardValue(valueListRes[i_4 + 1][0])) {
                    valueListRes.splice(i_4, 1);
                }
            }
            else if (i_4 == valueListRes.length - 1) {
                if (RuleChecker.getCardValue(valueListRes[i_4][0]) - 1 != RuleChecker.getCardValue(valueListRes[i_4 - 1][0])) {
                    valueListRes.splice(i_4, 1);
                }
            }
    ...
    RuleChecker.findFour_Pair = function (cardList, valueList, pcardList) {
        ...
        if (result.length >= 4) {
            ...
            for (var i_5 = 1; i_5 < 4; i_5++) {
                indexArr.push(RuleChecker.getIndexArrayOfNum(valueList1, i_5));
            }
            for (var i_6 = 0; i_6 < indexArr.length; i_6++) {
                var numIndexArr = indexArr[i_6];
    ...
    RuleChecker.findFour_Two_Pair = function (cardList, valueList, pcardList) {
        ...
        if (result.length >= 4) {
            ...
            for (var i_7 = 0; i_7 < indexArr.length; i_7++) {
                var numIndexArr = indexArr[i_7];
                if (numIndexArr.length != 0) {
                    for (var j = 0; j < numIndexArr.length; j++) {
                        for (var k = 0; k < valueList1[numIndexArr[j]].length; k++) {
                            if (valueList1[numIndexArr[j]][k] <= 0x4f) {
...
//# sourceMappingURL=rule-checker.js.map