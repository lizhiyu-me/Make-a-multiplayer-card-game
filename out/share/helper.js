...
export function getCardReadableName(cardNumber) {
    var _cardNumber = Number(cardNumber);
    var _value = _cardNumber % 0x10;
    return cardNumberNameDic[_value];
}
export function convert2ReadableNames(cardsArr) {
    var _res = [];
...
export function convert2CardNumbers(cardNames) {
    var _res = [];
